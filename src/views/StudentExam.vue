<template>
    <div class='bg'>
        <h2 align="center">欢迎，{{$route.params.sname}}同学，您共有{{tableData.length}}场考试。</h2>
...
<script>
    export default {
        ...
        created() {
            const _this = this
            axios.get('http://ffrfree.site:9901/api/exam/s/' + this.$route.params.sname).then(function (resp) {
